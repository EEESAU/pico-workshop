...
MCP23008::MCP23008(uint8_t address, i2c_inst_t* i2c)
...
bool MCP23008::isConnected()
{
  ...
  if (i2c_write_blocking(_i2c, _address, nullptr, 0, false) == PICO_ERROR_GENERIC)
  {
...
//  pin   = 0..7
//  value = LOW, HIGH
bool MCP23008::write1(uint8_t pin, bool value)
{
  if (pin > 7)
  {
    _error = MCP23008_PIN_ERROR;
...
bool MCP23008::read1(uint8_t pin)
{
  if (pin > 7)
  {
    _error = MCP23008_PIN_ERROR;
...
bool MCP23008::writeReg(uint8_t reg, uint8_t value)
{
  ...
  if (i2c_write_blocking(_i2c, _address, data, 2, false) == PICO_ERROR_GENERIC)
  {
    _error = MCP23008_I2C_ERROR;
    return false;
  }
...
{
  if (i2c_write_blocking(_i2c, _address, &reg, 1, false) == PICO_ERROR_GENERIC)
  {
    _error = MCP23008_I2C_ERROR;
    return 0;
  }
  uint8_t result = 0;
  if (i2c_read_blocking(_i2c, _address, &result, 1, false) == PICO_ERROR_GENERIC)
  {
    _error = MCP23008_I2C_ERROR;
    return 0;
  }
